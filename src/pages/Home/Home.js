...
const Home = () => {
    const games = [
        ...
        },
        {
          ...
          details: 'Alien Invasion pits you against the greatest threat humanity has ever faced: an all-out assault by hostile extraterrestrial forces. As a brave space marine, you will fight valiantly to defend Earth from the alien horde. Pilot advanced spacecraft, wield powerful weapons, and engage in intense firefights as you battle across alien worlds and space stations. Humanity\'s survival hangs in the balance – are you ready to save the world?',
        },
